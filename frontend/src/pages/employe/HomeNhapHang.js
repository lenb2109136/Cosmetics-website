...
import { save, savev2 } from "../../services/PhieuNhapService";
...
function HomeNhapHang() {
    ...
    const handleSave = () => {
        savev2(danhSachNhap, selectedSupplier, vat)
            .then(() => {
    ...
    return (
        <div className="relative">
            ...
            <div className="flex p-3">
                <table className="basis-[75%] border-collapse shadow-md rounded-md overflow-hidden min-w-min max-w-full">
                    <thead className="">
                                ...
                                <React.Fragment key={item.id}>
                                    {item.cacQuyCach.map((quyCach, subIndex) => (
                                        <tr
                                            ...
                                            className={`text-center transition ${item.cacQuyCach.length === 1 ? "h-fit" : ""}`}
                                            style={{ minHeight: item.cacQuyCach.length === 1 ? "60px" : "auto" }}
                                        >
                                            {subIndex === 0 && (
                                                <>
                                                    <td className="border p-2" rowSpan={item.cacQuyCach.length}>
                                                        {index + 1}
                                                    </td>
                                                    <td className="border p-2" rowSpan={item.cacQuyCach.length}>
                                                        <p className="font-bold">{item.tenSanPham}</p>
                                                        <span className=" text-green-900 pl-1 pr-1 rounded-sm shadow-sm">
        ...
        Xóa
                ...
                <div className="w-full basis-[25%] border-l-2 border ml-2  shadow-md p-4 rounded-md">
                   ...
                   <div className="flex justify-between">
                    ...
                    <div className="mb-6 flex items-center rounded-md">
                        <i className="fa-regular fa-user shadow-md text-green-900 p-2 border p-2 shadow-md rounded-md text-md"></i>
                        <div className="rounded-lg ml-1 pl-1 pr-1">
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white modal-compact">
                        ...
                        <p className="text-md text-gray-700 mb-5">
                            Bạn chắc chắn muốn tạo phiếu nhập này?
                        </p>
            ...
            {openScanModal && (
                <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 relative overflow-hidden transform transition-all duration-300">
                        ...
                        <p className="text-lg font-bold text-green-900 mb-6 text-center">Quét Mã Sản Phẩm</p>
                        <div className="scanner-container">
                            <div
                                ref={scannerRef}
                                className="w-full max-w-[360px] h-64 bg-gray-200 relative mx-auto"
                            />
                            <canvas
                                ref={canvasRef}
