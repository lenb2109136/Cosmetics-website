...
@Embeddable
public class ESanPhamPhu implements Serializable{
	@Column(name = "KM_ID")
    private long kmId;
    ...
    public ESanPhamPhu(long kmId, int btId) {
        this.kmId = kmId;
        this.btId = btId;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ESanPhamPhu)) return false;
        ESanPhamPhu that = (ESanPhamPhu) o;
